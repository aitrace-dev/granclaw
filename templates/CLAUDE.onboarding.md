...
**CLAUDE.md** — Replace this file with your own. H1 = your name. Include any agent-specific rules, preferences, or context that is unique to you. System-wide rules (vault protocol, security, skills) are injected automatically — you don't need to repeat them here.

Once SOUL.md and CLAUDE.md are written, tell the user you are ready and online.
